const steps = [
    {
      id: 1,
      title: "Bước 1:",
      summary: "Đánh giá hành vi – Phỏng vấn cá nhân để hiểu phong cách làm việc & thái độ ứng viên.",
      details: (
        <>
          <p><strong>Mục tiêu:</strong> Xác định cách ứng viên phản ứng trong môi trường làm việc, động lực làm việc và khả năng tương tác với học sinh, đồng nghiệp.</p>
          ...
          <p><strong>Câu hỏi và tình huống:</strong></p>
          <ul>
            <li>Gặp một học sinh chưa chăm chỉ, chưa rèn luyện được tính tự giác và thường xuyên trì trệ trong học tập, bạn sẽ làm gì?</li>
    ...
    },
    {
      ...
      details: (
        <>
          <p><strong>Mục tiêu:</strong> Kiểm tra khả năng tư duy logic, sáng tạo và lập kế hoạch.</p>
          <p><strong>Phương pháp đánh giá:</strong></p>
          <ul>
